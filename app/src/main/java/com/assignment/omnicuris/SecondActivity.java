...
public class SecondActivity extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String json = inputStreamToString(SecondActivity.this.getResources().openRawResource(R.raw.questions));

        Log.e("json", " " + json);
        parentsModel = new Gson().fromJson(json, ParentsModel.class);

        btnPrevious.setVisibility(View.VISIBLE);
        txtQuestion.setText(parentsModel.getQuestions().get(1).getQuestion());
        radioA.setText(parentsModel.getQuestions().get(1).getAnswers().get(0).getA());
        radioB.setText(parentsModel.getQuestions().get(1).getAnswers().get(0).getB());
        radioC.setText(parentsModel.getQuestions().get(1).getAnswers().get(0).getC());
        radioD.setText(parentsModel.getQuestions().get(1).getAnswers().get(0).getD());
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.btnNext :
                ...
                if (answer != null) {
                    SQLite sqLite = new SQLite(SecondActivity.this);
                    sqLite.addAnswer("2", answer);
                    startActivity(new Intent(SecondActivity.this, ThirdActivity.class));
                    finish();
                }
                else {
                    new MaterialAlertDialogBuilder(SecondActivity.this, R.style.ThemeOverlay_MaterialComponents_MaterialAlertDialog_Centered)
